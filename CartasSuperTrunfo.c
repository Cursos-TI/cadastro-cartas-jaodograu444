...
int main()
{
  ...
  double AreaEmKm2_1, AreaEmKm2_2;
  double PIB1, PIB2;
  ...
  printf("Área da cidade 1 em km²: %.2lf km² \n", AreaEmKm2_1);
  printf("PIB da cidade 1: %.2lf\n", PIB1);
  ...
  printf("Área da cidade 2 em km²: %.2lf km² \n", AreaEmKm2_2);
  printf("PIB da cidade 2: %.2lf\n", PIB2);
